...
public class DialegIntercambiaPosicionProductos {

    //Muestra un dialogo al usuario que le permite insertar los productos que quiere intercambiar su posicion en la estanteria.
    public Pair<Pair<String, String>, Pair<String, String>> mostrardialeg() {
        ...
        while (result == null) {
            ...
            if (opcion == JOptionPane.OK_OPTION) {
                ...
                if (nombreA.isEmpty() || marcaA.isEmpty() || nombreN.isEmpty() || marcaN.isEmpty()) { // Si algun input
                                                                                                      // està buit
                    ...
                    result = new Pair<>(new Pair<>(nombreA, marcaA), new Pair<>(nombreN, marcaN)); // Si els camps són
                                                                                                   // vàlids, sortim del
                                                                                                   // bucle
                }
            } else {
