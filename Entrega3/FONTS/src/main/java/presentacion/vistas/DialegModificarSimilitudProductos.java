...
public class DialegModificarSimilitudProductos {

    //Muestra un dialogo al usuario que le permite indicar a cuales productos quiere cambiar su grado de similitud.
    public Pair<Pair<String, String>, Pair<String, String>> mostrardialeg() {
        ...
        while (result == null) {
            int opcion = JOptionPane.showOptionDialog(
                    null,
                    panel,
                    "Modificar el grado de similitud entre dos productos",
            ...
            if (opcion == JOptionPane.OK_OPTION) {
                String nombre1 = NomProd1.getText().trim();
                String marca1 = MarcaProd1.getText().trim();
                String nombre2 = NomProd2.getText().trim();
                String marca2 = MarcaProd2.getText().trim();

                if (nombre1.isEmpty() || marca1.isEmpty() || nombre2.isEmpty() || marca2.isEmpty()) { // Si algun input
                                                                                                      // està buit
                    ...
                    result = new Pair<>(new Pair<>(nombre1, marca1), new Pair<>(nombre2, marca2)); // Si els camps són
                                                                                                   // vàlids, sortim del
                                                                                                   // bucle
                }
            } else {
